...
class MarketCalendar(val marketCalendarConfig: MarketCalendarConfig) {
    fun isMarketHoliday(
        ...
        val holidayMap = marketCalendarConfig.marketHolidays(date.year, market)

        return isHoliday(date, holidayMap) || isWeekend(date)
    }
    ...
    fun getNextBusinessDay(
        ...
        while (isHoliday(nextDay, holidayList) || isWeekend(nextDay)) {
    ...
    private fun isHoliday(
        ...
        return holidayMap.contains(date)
    }
