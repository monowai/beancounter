    ...
    fun toTrns(): List<Trn> =
        trns.map { dto ->
            Trn(
                ...
                cashAsset = dto.cashAssetId?.let { assets.getValue(it) },
                cashCurrency = dto.cashCurrencyCode?.let { currencies.getValue(it) },
                ...
                broker = dto.brokerId?.let { brokers.getValue(it) },
                version = dto.version,
                status = dto.status,
                modelId = dto.modelId,
