 ...
 * schedules and values against. A UTC clock reports yesterday's date for the first eight hours of
 * every local day in an east-of-UTC deployment; the LLM trusts that stamp (the system prompt tells
