...
class KeyGenUtilsTest {
    ...
    fun staticUuids() {
        ...
        verify(UUID(-7271966270884526335, -7048012152674439064))
        verify(UUID(46696621207273647, -5135048203407689936))
        verify(UUID(-6965057034889835965, -6067888309988012771))
        verify(UUID(1674956389701140531, -7919210516680745918))
    }
