...
/**
 * Accumulation logic for REDUCE transactions - same as SELL but without cash impact.
 * Used for reducing positions or adding liabilities without affecting cash positions.
 */
@Service
class ReduceBehaviour(
